...
export default function About() {
    ...
    return (
        ...
        <div className="container">
            <h2 style={{display:'flex',alignItems:'center',justifyContent:'center',color:'darkcyan'}}>About Us</h2>
            ...
            <div className="container my-3">
                <button type="button" className="btn btn-primary m-3" onClick={toggleBtn}>{btnText}</button>
            </div>
            </div>
        </>
    )
